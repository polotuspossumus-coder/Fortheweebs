...
You can grant **10 people** lifetime unlimited access (beyond yourself as owner, for a total of 11 VIP accounts).
...
9. vip8@example.com (Available)
10. vip9@example.com (Available)
11. vip10@example.com (Available)
