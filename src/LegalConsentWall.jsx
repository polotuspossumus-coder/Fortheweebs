 ...
 * LegalConsentWall
 * Props:
 *   onConsent (function, optional): called when user agrees to terms
 */
function LegalConsentWall({ onConsent }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="legal-consent-title" style={{ textAlign: 'center' }}>
          Legal Agreement Required
        </h2>
        <div style={{ whiteSpace: 'pre-wrap', fontSize: '1rem', marginBottom: '2rem' }}>
          {LEGAL_TEXT}
        </div>
        <button
          style={{
...
export default LegalConsentWall;
