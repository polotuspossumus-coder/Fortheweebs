...
exports.inscribeDecision = inscribeDecision;
exports.queryGovernanceHistory = queryGovernanceHistory;
 ...
 */
async function inscribeDecision(record) {
    ...
    console.log(`⚖️ GOVERNANCE: ${record.actionType} by ${record.authorizedBy || 'mico'} - ${record.justification}`);
    return data.id;
}
/**
...
//# sourceMappingURL=governanceNotary.js.map