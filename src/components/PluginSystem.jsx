...
const PluginSystem = ({ currentTool = 'video' }) => {
  ...
  const mockPlugins = [
    ...
    { id: 7, name: 'Object Eraser', developer: 'MagicEraser Co', category: 'photo', type: 'tool', price: 5.99, rating: 4.8, downloads: 67234, size: '14 MB', description: 'Remove unwanted objects like Photoshop Content-Aware Fill', version: '2.3.1', revenue: '70% to you', tags: ['remove', 'clean', 'ai'], icon: '✨', toolCompatibility: ['photo', 'video'] },
