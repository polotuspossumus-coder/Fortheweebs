...
export default function MobileGuildManager({ guild }) {
  return (
    <div className="p-4 max-w-sm mx-auto" aria-label="Guild manager">
      ...
      <button className="w-full bg-indigo-600 text-white py-2 rounded" aria-label="Invite validator">Invite Validator</button>
      <button className="mt-2 w-full bg-gray-700 text-white py-2 rounded" aria-label="View lore drops">View Lore Drops</button>
    </div>
  );
}
