...
router.post('/generate-environment', async (req, res) => {
  try {
    ...
    res.json({
      ...
      cubemapUrls: null, // TODO: convert to cubemap
      format: 'hdr',
...
router.post('/edit-360-video', async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      editedVideoUrl: videoUrl, // TODO: implement 360 video editing
...
async function convertToGLB(modelUrl) {
  ...
  return modelUrl; // TODO: implement conversion
}
