...
router.post('/create', async (req, res) => {
    try {
        const { userId, tier, currency = 'BTC' } = req.body;
...
router.post('/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
    try {
        ...
        console.log('Crypto payment webhook received:', event);
        ...
        if (event.type === 'charge:confirmed') {
            ...
            console.log(`✅ Crypto payment confirmed for user ${payment.user_id}: ${payment.tier}`);
        }
