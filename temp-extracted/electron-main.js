...
async function createMainWindow() {
  ...
  if (isOnline) {
    console.log('🌐 Online mode: Loading from Vercel');
    mainWindow.loadURL(VERCEL_URL);
  } else {
    console.log('💾 Offline mode: Starting local server');
    try {
      ...
      console.error('Failed to start offline mode:', err);
      mainWindow.loadURL(VERCEL_URL); // Fallback to online
    }
  }
